        ...
        if not skip_svm:
            strategies.append(
                strategy_from_trainer(
                    svm_trainer,
                    "svm-l8",
                    SvmConceptTrainerOptions(layer=8),
                    save_progress_dir=save_progress_dir,
                    seed=iteration_seed,
                    force_retrain_all=force_rerun_all,
                )
        ...
        if not skip_logistic:
            strategies.append(
                strategy_from_trainer(
                    logistic_trainer,
                    "logistic-l8",
                    LogisticRegressionConceptTrainerOptions(layer=8),
                    save_progress_dir=save_progress_dir,
                    seed=iteration_seed,
                    force_retrain_all=force_rerun_all,
                )
        ...
        if not skip_avg:
            strategies.append(
                strategy_from_trainer(
                    avg_trainer,
                    "avg-l8",
                    AvgConceptTrainerOptions(layer=8),
                    save_progress_dir=save_progress_dir,
                    seed=iteration_seed,
                    force_retrain_all=force_rerun_all,
                ),
